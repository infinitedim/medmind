...
mixin _$JournalEntry {
 ...
 String get id; DateTime get date; Mood? get mood; int? get moodIntensity; List<SymptomLog> get symptoms; List<MedicationLog> get medications; SleepRecord? get sleepRecord; List<LifestyleFactorLog> get lifestyleFactors; String? get freeText; List<ExtractedSymptom>? get extractedSymptoms; ActivityLevel? get activityLevel; VitalRecord? get vitalRecord; DateTime get createdAt; DateTime get updatedAt;
...
@useResult
$Res call({
 String id, DateTime date, Mood? mood, int? moodIntensity, List<SymptomLog> symptoms, List<MedicationLog> medications, SleepRecord? sleepRecord, List<LifestyleFactorLog> lifestyleFactors, String? freeText, List<ExtractedSymptom>? extractedSymptoms, ActivityLevel? activityLevel, VitalRecord? vitalRecord, DateTime createdAt, DateTime updatedAt
});


$SleepRecordCopyWith<$Res>? get sleepRecord;$VitalRecordCopyWith<$Res>? get vitalRecord;
...
as ActivityLevel?,vitalRecord: freezed == vitalRecord ? _self.vitalRecord : vitalRecord // ignore: cast_nullable_to_non_nullable
as VitalRecord?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$VitalRecordCopyWith<$Res>? get vitalRecord {
    if (_self.vitalRecord == null) {
    return null;
  }

  return $VitalRecordCopyWith<$Res>(_self.vitalRecord!, (value) {
    return _then(_self.copyWith(vitalRecord: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime date,  Mood? mood,  int? moodIntensity,  List<SymptomLog> symptoms,  List<MedicationLog> medications,  SleepRecord? sleepRecord,  List<LifestyleFactorLog> lifestyleFactors,  String? freeText,  List<ExtractedSymptom>? extractedSymptoms,  ActivityLevel? activityLevel,  VitalRecord? vitalRecord,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JournalEntry() when $default != null:
return $default(_that.id,_that.date,_that.mood,_that.moodIntensity,_that.symptoms,_that.medications,_that.sleepRecord,_that.lifestyleFactors,_that.freeText,_that.extractedSymptoms,_that.activityLevel,_that.vitalRecord,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime date,  Mood? mood,  int? moodIntensity,  List<SymptomLog> symptoms,  List<MedicationLog> medications,  SleepRecord? sleepRecord,  List<LifestyleFactorLog> lifestyleFactors,  String? freeText,  List<ExtractedSymptom>? extractedSymptoms,  ActivityLevel? activityLevel,  VitalRecord? vitalRecord,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _JournalEntry():
return $default(_that.id,_that.date,_that.mood,_that.moodIntensity,_that.symptoms,_that.medications,_that.sleepRecord,_that.lifestyleFactors,_that.freeText,_that.extractedSymptoms,_that.activityLevel,_that.vitalRecord,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime date,  Mood? mood,  int? moodIntensity,  List<SymptomLog> symptoms,  List<MedicationLog> medications,  SleepRecord? sleepRecord,  List<LifestyleFactorLog> lifestyleFactors,  String? freeText,  List<ExtractedSymptom>? extractedSymptoms,  ActivityLevel? activityLevel,  VitalRecord? vitalRecord,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _JournalEntry() when $default != null:
return $default(_that.id,_that.date,_that.mood,_that.moodIntensity,_that.symptoms,_that.medications,_that.sleepRecord,_that.lifestyleFactors,_that.freeText,_that.extractedSymptoms,_that.activityLevel,_that.vitalRecord,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _JournalEntry implements JournalEntry {
  const _JournalEntry({required this.id, required this.date, this.mood, this.moodIntensity, final  List<SymptomLog> symptoms = const [], final  List<MedicationLog> medications = const [], this.sleepRecord, final  List<LifestyleFactorLog> lifestyleFactors = const [], this.freeText, final  List<ExtractedSymptom>? extractedSymptoms, this.activityLevel, this.vitalRecord, required this.createdAt, required this.updatedAt}): _symptoms = symptoms,_medications = medications,_lifestyleFactors = lifestyleFactors,_extractedSymptoms = extractedSymptoms;
...
@override final  VitalRecord? vitalRecord;
...
@override $SleepRecordCopyWith<$Res>? get sleepRecord;@override $VitalRecordCopyWith<$Res>? get vitalRecord;
